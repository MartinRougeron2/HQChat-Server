...
const REDACTORS: Array<{ re: RegExp; to: string }> = [
  ...
  // Credentials embedded in a URL's userinfo, e.g. redis://:pw@host,
  // postgres://user:pw@host — the classic way a secret rides in a connection
  // error. Keep the scheme + host, drop the userinfo.
  {
